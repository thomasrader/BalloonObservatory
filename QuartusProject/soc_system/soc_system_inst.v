	soc_system u0 (
		...
		.uart_data_in_export                   (<connected-to-uart_data_in_export>),                   //              uart_data_in.export
		.uart_data_out_export                  (<connected-to-uart_data_out_export>),                  //             uart_data_out.export
		.uart_flags_export                     (<connected-to-uart_flags_export>),                     //                uart_flags.export
		.uart_addr_export                      (<connected-to-uart_addr_export>)                       //                 uart_addr.export
	);
